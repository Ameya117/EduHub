...
const QNA = () => {
  ...
  return (
    ...
    <div className="hia">
      ...
      <div className="gap-y-[2rem] grid grid-cols-3">
        <ReactCardFlip isFlipped={isFlipped1} flipDirection="verical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            <h1 className="p-2 text-2xl font-semibold text-center">
              What are the benefits of regular exercise?
            </h1>
            <button onClick={handleClick1}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
        ...
        <ReactCardFlip isFlipped={isFlipped2} flipDirection="vertical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick2}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            <div className="p-2 font-extralight  text-center">
        ...
        <ReactCardFlip isFlipped={isFlipped3} flipDirection="vertical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick3}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick3}>Click to flip</button>
          </div>
        </ReactCardFlip>
        <ReactCardFlip isFlipped={isFlipped4} flipDirection="vertical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick4}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            <div className="font-extralight  text-center p-2">
            ...
            <button onClick={handleClick4}>Click to flip</button>
          </div>
        </ReactCardFlip>
        <ReactCardFlip isFlipped={isFlipped5} flipDirection="vertical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick5}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            <div className="font-extralight  text-center p-2">
            ...
            <button onClick={handleClick5}>Click to flip</button>
          </div>
        </ReactCardFlip>
        <ReactCardFlip isFlipped={isFlipped6} flipDirection="vertical">
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            ...
            <button onClick={handleClick6}>Click to view answer</button>
          </div>
          <div className="h-[20rem] w-[20rem] bg-gray-100 flex flex-col justify-center items-center mx-auto">
            <div className="font-extralight  text-center p-2">
            ...
            <button onClick={handleClick6}>Click to flip</button>
          </div>
        </ReactCardFlip>
      </div>
      </>
